...
public class ExceptionHandlingMiddleware : IMiddleware
{
    ...
    private static IReadOnlyCollection<Contract.Abstractions.Shared.Error> GetErrors(Exception exception)
    {
        IReadOnlyCollection<Contract.Abstractions.Shared.Error> errors = null;
