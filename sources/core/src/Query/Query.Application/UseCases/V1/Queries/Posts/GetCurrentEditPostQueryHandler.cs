...
public sealed class GetCurrentEditPostQueryHandler : IQueryHandler<Contract.Services.V1.Posts.Query.GetCurrentEditPost, Response.PostDraftReponse>
{
    ...
    public async Task<Result<Response.PostDraftReponse>> Handle(Contract.Services.V1.Posts.Query.GetCurrentEditPost request, CancellationToken cancellationToken)
    {
        ...
        {
            var initialCurrentEditPost = new Response.PostDraftReponse(null, "", "", userId, [], PostStatus.Draft);
        ...
        var currentEditPost = new Response.PostDraftReponse(postCurrentEdit.DocumentId, postCurrentEdit.Title, postCurrentEdit.Content, userId, tagIds, PostStatus.Draft);
