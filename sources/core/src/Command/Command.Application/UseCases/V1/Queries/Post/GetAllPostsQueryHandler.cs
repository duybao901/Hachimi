...
public sealed class GetAllPostsQueryHandler : IQueryHandler<GetAllPostsQuery, List<Response.PostResponse>>
{
    private readonly IRepositoryBase<Domain.Entities.Posts, Guid> _postRepository;
    private readonly IMapper _mapper;


    public GetAllPostsQueryHandler(IRepositoryBase<Domain.Entities.Posts, Guid> postRepository, IMapper mapper)
    {
