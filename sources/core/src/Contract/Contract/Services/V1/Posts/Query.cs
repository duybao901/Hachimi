...
{
    public record GetPublicPostsQuery(int PageIndex, int PageSize, string Feed) : IQuery<PageResult<Response.PostResponse>>;
    ...
    public record GetAuthorDraftPostsQuery(Guid AuthorId) : IQuery<List<Response.PostResponse>>;
}
