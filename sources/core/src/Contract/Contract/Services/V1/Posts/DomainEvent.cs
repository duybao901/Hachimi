...
public static class DomainEvent
{
    ...
    public record PostSavedEvent(Guid IdEvent, Guid Id, string Title, string Slug, string Content, string CoverImgUrl, Guid UserId, ICollection<Guid> TagIds) : IDomainEvent, ICommand;
}
