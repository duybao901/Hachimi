    ...
    <div className="w-full flex items-center justify-center gap-10 p-10">
      <div className="w-[640px] p-12">
        <div className="mb-6 text-center">
          ...
          <h1 className="text-3xl font-bold mb-2">Join the Hachimi Community</h1>
          <p>Hachimi Community is a community of 3,620,351 amazing developers</p>
        </div>
            ...
            <Button type="submit" disabled={isLoading}>
              {isLoading ? (
                <p className="flex items-center">
                  <Spinner className="mr-2"></Spinner> Log in...
                </p>
              ) : (
                "Log in"
              )}
