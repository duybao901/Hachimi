...
import { BookmarkIcon, HeartPlusIcon, MessageCircleIcon, ShareIcon } from 'lucide-react';
                ...
                <div className="hidden lg:block w-16">
                  <div className="sticky top-24 flex flex-col items-center gap-6 text-gray-500">
                    ...
                    <button className="flex flex-col items-center hover:text-blue-500 transition">
                      ...
                      <span className="text-sm mt-1">{post.comments?.length || 0}</span>
                    </button>
                    ...
                    <button className="flex flex-col items-center hover:text-gray-700 transition">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          Posted on {post.publishedAt ? new Date(post.publishedAt).toLocaleDateString() : ''}
                        </div>
                      </div>
                    </div>
